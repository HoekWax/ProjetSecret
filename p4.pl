...
% La vérification de victoire verticale est bugué, la régler avec des write pour afficher le valeur
...
% sublist/2 vérifie qu'une liste est contenue dans une autre (Params : S = sous-liste, L = liste)
